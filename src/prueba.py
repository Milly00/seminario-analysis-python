...
def test_create_publication(app,client):
    data_json = {
    "profile_name": "rionoticiasco",
    "name_post": "CqJYX82OgAj",
    "id_admin": "adminp",
    "descripcion": "prueba",
    "n_redsocial": "instagram",
    "url_publicacion": "https://www.instagram.com/p/CqJYX82OgAj/",
    "categoria": "Ocio"
    }
    response = client.post("/analysis", json=data_json)
    print(response)
    assert response.status_code == 200
